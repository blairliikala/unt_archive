    ...
    keyboard.onTextChange = function() {
        ...
        if ( keyboard.text.length >= 1 ) {
            ...
            xhttp.addEventListener("load", function() {
                                   ...
                                   doc.getElementsByTagName("section").item(0).innerHTML = xhttp.responseText;
                                   }, false);
            
            
//            xhttp.addEventListener("load", function() {
//                                   // And the dynamically generated shelf to the collection list.
//                                   doc.getElementsByTagName("collectionList").item(0).innerHTML = '&lt;shelf&gt; &lt;section&gt;' + xhttp.responseText + '&lt;/section&gt; &lt;/shelf&gt;';
//                                   }, false);
//            
//            
...
//            xhttp.open("GET", "https://recording.music.unt.edu/index.php/tvml/search_results/search&keywords=" + searchText, true);

            xhttp.open("GET", "https://recording.music.unt.edu/index.php/tvml/search_results?keywords=" + searchText, true);
            ...
            doc.getElementsByTagName("section").item(0).innerHTML = `&lt;shelf /&gt;`;
        }
    }
},
    ...
    load: function(event) {
      ...
      if(videoURL) {   
            ...
            mediaItem.title = ele.getAttribute("data-title");
            mediaItem.subtitle = ele.getAttribute("data-subtitle");
            mediaItem.description = ele.getAttribute("data-description");
            mediaItem.artworkImageURL = ele.getAttribute("data-artworkImageURL");
