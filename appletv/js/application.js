...
App.onLaunch = function(options) {
    var javascriptFiles = [
        `https://recording.music.unt.edu/appletv/js/ResourceLoader.js`,
        `https://recording.music.unt.edu/appletv/js/Presenter.js`
    ];
    ...
    evaluateScripts(javascriptFiles, function(success) {
        if (success) {
            ...
            var index = resourceLoader.loadResource(`https://recording.music.unt.edu/tvml/`,
                function(resource) {
